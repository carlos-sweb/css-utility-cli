global_css_property gridTemplateColumns {"grid-template-columns",{
...
global_css_property gridColumn {"grid-column",{
  {"col-auto","auto"},
...
global_css_property gridColumnStart {"grid-column-start",{
  {"col-start-1","'1'"},
  {"col-start-2","'2'"},
  {"col-start-3","'3'"},
  {"col-start-4","'4'"},
...
global_css_property gridColumnEnd {"grid-column-end",{
  {"col-end-1","'1'"},
  {"col-end-2","'2'"},
  {"col-end-3","'3'"},
  {"col-end-4","'4'"},
...
global_css_property gridTemplateRows {"grid-template-rows",{
...
global_css_property gridRow {"grid-row",{
  {"row-auto","auto"},
...
global_css_property gridRowStart {"grid-row-start",{
  {"row-start-1","'1'"},
  {"row-start-2","'2'"},
  {"row-start-3","'3'"},
  {"row-start-4","'4'"},
...
global_css_property gridRowEnd {"grid-row-end",{
  {"row-end-1","'1'"},
  {"row-end-2","'2'"},
  {"row-end-3","'3'"},
  {"row-end-4","'4'"},
...
global_css_property gridAutoFlow {"grid-auto-flow",{
  {"grid-flow-row","row"},
  {"grid-flow-col","col"},
...
global_css_property gridAutoColumns {"grid-auto-columns",{
  {"auto-cols-auto","auto"},
...
global_css_property gridAutoRows {"grid-auto-rows",{
  {"auto-rows-auto","auto"},
